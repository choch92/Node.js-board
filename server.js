/*
    http보다 개선된 express 모듈을 이용해서 서버 구축!!
    express 모듈은 http보다 기능도 많고 미들웨어가 많이 지원된다..
...
// 정적자원은 라우팅의 대상이 아니다. 따라서 정적자원의 위치를 지정하면 별도의 라우팅이 필요없다...
// (요청을 처리할 컨트롤러 지정필요없다...)
...
// 게시판 목록 요청
// 클라이언트의 기종에 종속되면 안된다!! 서버는 다양한 디바이스에 대응해야 한다.
// 따라서 데이터 전송은 되도록이면 중립적 형태의 데이터로 보내야 한다!!(XML, JSON)
/*
